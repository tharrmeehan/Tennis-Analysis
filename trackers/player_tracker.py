...
class PlayerTracker:
    """
    The PlayerTracker class is used to detect players in a frame or multiple frames.
    It uses YOLO model to detect players.
    """
    ...
    # This method is used to detect players in multiple frames.
    def detect_frames(self, frames, read_from_stubs=False, stub_path=None):
        player_detections = []

        # Read player detections from a pickle file
        ...
        # Save player detections to a pickle file
        if stub_path is not None:
            with open(stub_path, "wb") as f:
                pickle.dump(player_detections, f)

        return player_detections  # Results of all frames
    ...
    def detect_frame(self, frame):
        ...
        return player_dict  # Results of 1 frame
